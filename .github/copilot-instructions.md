...
This means, you are allowed to modify existing laravel schemas, implementing breaking changes without worrying about backward compatibility, etc.
...
- Using Spatie Query for query building
- Using Spatie Data for validation(preferably, if applicable)
- Using Laravel Wayfinder for navigation
- Using Tanstack table for data tables
...
3. The user can directly upload digital and social media files from the dashboard
4. Dashboard page should show greeting
...
2. Handle upload file error in google drive, probably its because the image file format is webp
...
- Do not forget to utilize Shadcn and MagicUI components, you can utilize the existing Shadcn and MagicUI mcp to help you build the page faster.
