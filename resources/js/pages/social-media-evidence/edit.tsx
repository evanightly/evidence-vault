...
interface SocialMediaEvidenceEditProps {
  record: SocialMediaEvidenceRecord;
}

export default function SocialMediaEvidenceEdit({ record }: SocialMediaEvidenceEditProps) {
  ...
  return (
    <AppLayout>
      <Head title="Edit Social Media Evidence" />
      <Form {...SocialMediaEvidenceController.update.form(record.id)}
        ...
        {({ errors, processing }) => (
          <div className="space-y-6 rounded-xl border bg-card p-8 shadow-sm">
            <div className="space-y-2">
              <h1 className="text-2xl font-semibold tracking-tight">Edit Social Media Evidence</h1>
