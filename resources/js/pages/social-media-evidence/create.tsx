...
interface SocialMediaEvidenceCreateProps {}

export default function SocialMediaEvidenceCreate() {
  ...
  return (
    <AppLayout>
      <Head title="Create Social Media Evidence" />
      <Form {...SocialMediaEvidenceController.store.form()}
        ...
        {({ errors, processing }) => (
          <div className="space-y-6 rounded-xl border bg-card p-8 shadow-sm">
            <div className="space-y-2">
              <h1 className="text-2xl font-semibold tracking-tight">Create Social Media Evidence</h1>
