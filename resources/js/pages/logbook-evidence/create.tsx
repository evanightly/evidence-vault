...
interface LogbookEvidenceCreateProps {}

export default function LogbookEvidenceCreate() {
  ...
  const [logbookId, setLogbookId] = useState<number | string | null>(null);

  return (
    <AppLayout>
      <Head title="Create Logbook Evidence" />
      <Form {...LogbookEvidenceController.store.form()}
        ...
        {({ errors, processing }) => (
          <div className="space-y-6 rounded-xl border bg-card p-8 shadow-sm">
            <div className="space-y-2">
              <h1 className="text-2xl font-semibold tracking-tight">Create Logbook Evidence</h1>
