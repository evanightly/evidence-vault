...
interface LogbookEvidenceShowProps {
  record: LogbookEvidenceRecord;
}

export default function LogbookEvidenceShow({ record }: LogbookEvidenceShowProps) {
  return (
    <AppLayout>
      <Head title="Logbook Evidence" />
      <div className="mx-auto max-w-3xl space-y-6 py-6">
        <h1 className="text-2xl font-semibold">Logbook Evidence</h1>
