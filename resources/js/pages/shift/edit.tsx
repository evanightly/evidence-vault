...
export default function ShiftEdit({ record }: ShiftEditProps) {
  ...
  return (
    <AppLayout>
      ...
      <Form {...ShiftController.update.form(record.id)}
            ...
            <div className="grid gap-6">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  type="datetime-local"
                  required
                  defaultValue={normalizeFieldValue(record.start_time)}
                />
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  type="datetime-local"
                  required
                  defaultValue={normalizeFieldValue(record.end_time)}
                />
