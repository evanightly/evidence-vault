...
interface DigitalEvidenceCreateProps {}

export default function DigitalEvidenceCreate() {
  ...
  return (
    <AppLayout>
      <Head title="Create Digital Evidence" />
      <Form {...DigitalEvidenceController.store.form()}
        ...
        {({ errors, processing }) => (
          <div className="space-y-6 rounded-xl border bg-card p-8 shadow-sm">
            <div className="space-y-2">
              <h1 className="text-2xl font-semibold tracking-tight">Create Digital Evidence</h1>
