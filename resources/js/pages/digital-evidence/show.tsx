...
interface DigitalEvidenceShowProps {
  record: DigitalEvidenceRecord;
}

export default function DigitalEvidenceShow({ record }: DigitalEvidenceShowProps) {
  return (
    <AppLayout>
      <Head title="Digital Evidence" />
      <div className="mx-auto max-w-3xl space-y-6 py-6">
        <h1 className="text-2xl font-semibold">Digital Evidence</h1>
