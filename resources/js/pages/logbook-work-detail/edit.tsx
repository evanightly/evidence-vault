...
interface LogbookWorkDetailEditProps {
  record: LogbookWorkDetailRecord;
}

export default function LogbookWorkDetailEdit({ record }: LogbookWorkDetailEditProps) {
  ...
  return (
    <AppLayout>
      <Head title="Edit Logbook Work Detail" />
      <Form {...LogbookWorkDetailController.update.form(record.id)}
        ...
        {({ errors, processing }) => (
          <div className="space-y-6 rounded-xl border bg-card p-8 shadow-sm">
            <div className="space-y-2">
              <h1 className="text-2xl font-semibold tracking-tight">Edit Logbook Work Detail</h1>
